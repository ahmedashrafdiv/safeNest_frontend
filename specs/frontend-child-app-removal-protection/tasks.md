...
- [x] FT001 Add pure protection capability/state models.
- [x] FT002 Add tests for consumer, profile-owner, device-owner, stale, and tampered states.
...
- [ ] FT006 Add challenge-response client and visible parent approval state.
- [ ] FT007 Add durable health events and retry behavior.
- [ ] FT008 Add reboot/package replacement/tamper tests.
